                                    ...
                                    <div className="card-body rounded-0 text-left">
                                        ...
                                        <form>
                                            ...
                                            <div className="form-check text-left mb-3">
                                                ...
                                                <a href="/forgot" className="fw-600 font-xsss text-grey-700 mt-1 float-right">আপোনাৰ পাছৱৰ্ড পাহৰিছে নেকি?</a>
                                            </div>
                                        </form>
                                        
                                        <div className="col-sm-12 p-0 text-left">
                                            <div className="form-group mb-1"><a href="/login" className="form-control text-center style2-input text-white fw-600 bg-dark border-0 p-0 ">লগইন</a></div>
